...
echo "  中文报告:        ${CF_BASE_URL}/reports/$DATE_SLUG/${HTML_FILENAME%.html}"
echo "  英文报告:        ${CF_BASE_URL}/reports/$DATE_SLUG/${HTML_FILENAME_EN%.html}"
echo "  历史归档:        ${CF_BASE_URL}/reports/latest"
