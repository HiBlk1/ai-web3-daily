...
(function() {
  ...
  c1.setOption({animation:false,tooltip:Object.assign({trigger:'axis',axisPointer:{type:'shadow'},formatter:function(p){return p[0].name+'<br/>同比：'+p[0].value+'%';}},tooltip()),grid:{left:'8%',right:'8%',top:'8%',bottom:'18%',containLabel:true},xAxis:Object.assign({type:'category',data:['中国AI\n行业增速','Azure\n云服务','AWS\n营收','智能算力\n规模'],axisLabel:{interval:0,color:muted,fontSize:10,lineHeight:14}},axisStyle()),yAxis:Object.assign({type:'value',name:'同比增长率 (%)',nameTextStyle:{color:muted}},axisStyle()),series:[{type:'bar',barWidth:'48%',data:[{value:30,itemStyle:{color:accent2}},{value:43,itemStyle:{color:accent}},{value:28,itemStyle:{color:accent3}},{value:180,itemStyle:{color:danger}}],label:{show:true,position:'top',color:ink,fontSize:11,formatter:'{c}%'},itemStyle:{borderRadius:[6,6,0,0]}}]});
