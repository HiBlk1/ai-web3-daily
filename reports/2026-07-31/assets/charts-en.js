...
(function() {
  ...
  c1.setOption({animation:false,tooltip:Object.assign({trigger:'axis',axisPointer:{type:'shadow'},formatter:function(p){return p[0].name+'<br/>Value: '+p[0].value;}},tooltip()),grid:{left:'8%',right:'8%',top:'8%',bottom:'20%',containLabel:true},xAxis:Object.assign({type:'category',data:['China AI\nGrowth','Azure\nYoY Growth','Moonshot\nValuation','Microsoft\n1-Day Mkt Cap+'],axisLabel:{interval:0,color:muted,fontSize:10,lineHeight:14}},axisStyle()),yAxis:Object.assign({type:'value',name:'Value (% / USD B)',nameTextStyle:{color:muted}},axisStyle()),series:[{type:'bar',barWidth:'48%',data:[{value:30,itemStyle:{color:accent2}},{value:43,itemStyle:{color:accent}},{value:35,itemStyle:{color:accent3}},{value:450,itemStyle:{color:danger}}],label:{show:true,position:'top',color:ink,fontSize:11,formatter:function(p){return p.dataIndex===0||p.dataIndex===1?p.value+'%':'$'+p.value+'B';}},itemStyle:{borderRadius:[6,6,0,0]}}]});
